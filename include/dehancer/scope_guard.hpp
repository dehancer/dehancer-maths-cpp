...
namespace dehancer
{
    ...
    dehancer::detail::scope_guard from befriending a dehancer::make_scope_guard
...
////////////////////////////////////////////////////////////////////////////////
template<typename Callback>
dehancer::detail::scope_guard<Callback>::scope_guard(Callback&& callback)
noexcept(std::is_nothrow_constructible<Callback, Callback&&>::value)
...
////////////////////////////////////////////////////////////////////////////////
template<typename Callback>
dehancer::detail::scope_guard<Callback>::~scope_guard() noexcept
{
    if(m_active)
        m_callback();
}
...
////////////////////////////////////////////////////////////////////////////////
template<typename Callback>
dehancer::detail::scope_guard<Callback>::scope_guard(scope_guard&& other)
noexcept(std::is_nothrow_constructible<Callback, Callback&&>::value)
...
////////////////////////////////////////////////////////////////////////////////
template<typename Callback>
inline void dehancer::detail::scope_guard<Callback>::dismiss() noexcept
{
    m_active = false;
}
...
////////////////////////////////////////////////////////////////////////////////
template<typename Callback>
inline auto dehancer::detail::make_scope_guard(Callback&& callback)
noexcept(std::is_nothrow_constructible<Callback, Callback&&>::value)
